                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a href="/admin"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">WSAPP</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    WSAPP adalah aplikasi pencatatan alat berat untuk departement Workshop PT. Bridgestone Kalimantan Plantation. Semua data pemakaian alat berat ada disini.
                                </p>
                            </div>
